...
public class BayerIdentify extends TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        intent = new Intent().setClass(this, SampIdentify.class);
...
//        tabHost.getTabWidget().getChildAt(tabHost.getCurrentTab()).getBackground().setAlpha(50);
            ...
            tabHost.getTabWidget().getChildAt(t).setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    if (event.getAction() == MotionEvent.ACTION_DOWN
                        ...
                        if (currentTab == 1) {
                            intent = new Intent(getBaseContext(), BayerIdentify2.class).addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(BayerIdentify.this, BayerIdentify2.class);
        startActivity(i);
    }
