...
public class BayerTurfManagementActivity extends TabActivity {
    private Integer setCurrTab = 2;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        searchImgView.setImageResource(R.drawable.settings_copy1);
        ...
        intent = new Intent().setClass(this, IdentifyConfrm.class);
        ...
        identifyImgView.setImageResource(R.drawable.identify_copy1);
        ...
        homeImgView.setImageResource(R.drawable.home_copy1);
        ...
        contactImgView.setImageResource(R.drawable.aboutus_copy1);
        ...
        distImgView.setImageResource(R.drawable.distributors_copy1);
            ...
            tabHost.getTabWidget().getChildAt(t).setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    if (event.getAction() == MotionEvent.ACTION_DOWN
                        ...
                        if (currentTab == 2) {
                            intent = new Intent(getBaseContext(), BayerTurfManagementActivity.class);
