...
public class BayerMappingTurf extends TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        intent = new Intent().setClass(this, MyClubsActivity.class).addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
...
//        if(tabIn==true) {
        intent = new Intent().setClass(this, Mapping_Activity.class);
